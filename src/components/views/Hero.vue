...
<template>
  <div id="hero-cont" class="full-container">
    <div class="left">
      ...
      <p>Upload your data from
        <a href="https://aprs.fi/export/" target="_blank">aprs.fi</a>
        to get started
      </p>
      <p class="small">a LocalNewsTV experience</p>
    </div>
    <div class="right">
      <FileUploader v-model="jsonContentModel" />
    </div>
  </div>
</template>
<!-- //  -->
